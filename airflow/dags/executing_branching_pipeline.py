...
def read_csv_file(ti):
    df = pd.read_csv('/workspaces/Files_Learning_Apache_Airflow/airflow/datasets/insurance.csv')
...
def filter_by_region(ti):
    ...
    region_df.to_csv('/workspaces/Files_Learning_Apache_Airflow/airflow/output/filtered_by_region.csv', index=False)
...
def filter_bmi_smoker_charges(ti):
    ...
    selected_cols_df.to_csv('/workspaces/Files_Learning_Apache_Airflow/airflow/output/selected_cols.csv', index=False)
...
def groupby_region_smoker(ti):
    ...
    region_df.to_csv('/workspaces/Files_Learning_Apache_Airflow/airflow/output/grouped_by_region.csv', index=False)
    ...
    smoker_df.to_csv('/workspaces/Files_Learning_Apache_Airflow/airflow/output/grouped_by_smoker.csv', index=False)
