...
def groupby_smoker(ti):
    ...
    smoker_df.to_csv(
        '/workspaces/Files_Learning_Apache_Airflow/airflow/output/grouped_by_smoker.csv', index=False)
...
def groupby_region(ti):
    ...
    region_df.to_csv(
        '/workspaces/Files_Learning_Apache_Airflow/airflow/output/grouped_by_region.csv', index=False)
